...
mod 'theforeman/puppetserver_foreman', :git => 'https://github.com/theforeman/puppet-puppetserver_foreman', :ref => '2.2.0'
...
# Top-level modules
mod 'theforeman/foreman',       :git => 'https://github.com/theforeman/puppet-foreman',       :ref => '22.2.0'
mod 'theforeman/foreman_proxy', :git => 'https://github.com/theforeman/puppet-foreman_proxy', :ref => '24.2.0'
...
mod 'puppet-r10k',      :git => 'https://github.com/voxpupuli/puppet-r10k',       :ref => 'v10.3.0'
